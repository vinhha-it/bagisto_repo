...
class Themes
{
    ...
    public function __construct()
    {
        ...
        } else if (! Str::contains(request()->url(), 'super/')) {
            $this->defaultThemeCode = Config::get('themes.super-default', null);
        } else if (! Str::contains(request()->url(), 'company/')) {
            $this->defaultThemeCode = Config::get('themes.company-default', null);
        } else {
    ...
    public function loadThemes()
    {
        ...
        if (Str::contains(request()->url(), config('app.admin_url').'/')) {
            ...
            $themes = config('themes.super', []);
        } else if (Str::contains(request()->url(), 'company/')) {
            $themes = config('themes.company', []);
        } else {
            $themes = config('themes.shop', []);
        }
