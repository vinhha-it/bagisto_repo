...
>
    ...
    <!-- Page Title -->
    <x-slot:title>
        {{ $status }} @lang("saas::app.tenant.custom-errors.not-allowed-to-visit-this-section")
    </x-slot>
			...
			<div class="wrapper-404 max-868:!text-[294px] max-md:!text-[140px]">
				...
				<div class="absolute left-[50%] top-[80%] mt-10 -translate-x-[50%] -translate-y-[50%] text-center max-868:w-full">
					<h1 class="text-3xl font-semibold">
                        @lang("saas::app.tenant.custom-errors.illegal-action")
                    </h1>

					<p class="mt-2 text-lg text-[#6E6E6E]">
                        @lang("saas::app.tenant.custom-errors.illegal-message")
                    </p>
