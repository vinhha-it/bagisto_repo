            ...
            <div class="flex gap-2.5 mt-3.5 max-xl:flex-wrap">
                <div class="flex flex-col gap-2 flex-1 max-xl:flex-auto">
                    <div class="p-4 bg-white dark:bg-gray-900 rounded box-shadow">
                        ...
                        <div class="flex gap-x-2.5 justify-between items-center mb-2.5">
                            <div class="flex flex-col gap-1">
                                <p class="text-base text-gray-800 dark:text-white font-semibold">
                                    @lang('saas::app.super.settings.themes.edit.footer-link')
                                </p>

                                <p class="text-xs text-gray-500 dark:text-gray-300 font-medium">
                                    @lang('saas::app.super.settings.themes.edit.footer-link-description')
                                </p>
                            </div>
                            ...
                            <div class="flex gap-2.5">
                                ...
                                >
                                    @lang('saas::app.super.settings.themes.edit.add-link')
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="flex gap-2.5">
                                        <div class="grid gap-1.5 place-content-start">
                                            <p class="text-gray-600 dark:text-gray-300">
                                                <div> 
                                                    @lang('saas::app.super.settings.themes.edit.column'): 
                                            ...
                                            <p class="text-gray-600 dark:text-gray-300">
                                                <div> 
                                                    @lang('saas::app.super.settings.themes.edit.url'):
                                            ...
                                            <p class="text-gray-600 dark:text-gray-300">
                                                <div> 
                                                    @lang('saas::app.super.settings.themes.edit.filter-title'):
                                    ...
                                    <div class="grid gap-1 place-content-start text-right">
                                        <div class="flex gap-1.5 items-center">
                                            <p 
                                                ...
                                                @click="edit(link, key)"
                                            > 
                                                @lang('saas::app.super.settings.themes.edit.edit')
                                            </p>
                                            ...
                                            > 
                                                @lang('saas::app.super.settings.themes.edit.delete')
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div   
                            v-else
                            class="grid gap-2.5.5 justify-center justify-items-center py-10 px-2.5"
                        >
                            <img
                            ...
                            <div class="secondary-button">
                                @lang('saas::app.super.settings.themes.edit.add-footer-link-btn')
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <x-admin::modal ref="addLinksModal">
                        ...
                        <x-slot:header>
                            <p class="text-lg text-gray-800 dark:text-white font-bold">
                                @lang('saas::app.super.settings.themes.edit.footer-link-form-title')
                            </p>
                        </x-slot:header>
                        ...
                        <x-slot:content>
                            ...
                            <x-admin::form.control-group class="mb-2.5">
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    name="column"
                                    rules="required"
                                    :label="trans('saas::app.super.settings.themes.edit.column')"
                                    :placeholder="trans('saas::app.super.settings.themes.edit.column')"
                                    ::disabled="isUpdating"
                                >
                            ...
                            <x-admin::form.control-group class="mb-2.5">
                                <x-admin::form.control-group.label class="required">
                                    @lang('saas::app.super.settings.themes.edit.footer-title')
                                </x-admin::form.control-group.label>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    name="title"
                                    rules="required"
                                    :label="trans('saas::app.super.settings.themes.edit.footer-title')"
                                    :placeholder="trans('saas::app.super.settings.themes.edit.footer-title')"
                                >
                                </x-admin::form.control-group.control>
                            ...
                            <x-admin::form.control-group class="mb-2.5">
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    name="url"
                                    rules="required|url"
                                    :label="trans('saas::app.super.settings.themes.edit.url')"
                                    :placeholder="trans('saas::app.super.settings.themes.edit.url')"
                                >
                                </x-admin::form.control-group.control>
                            ...
                            <x-admin::form.control-group class="mb-2.5">
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :label="trans('saas::app.super.settings.themes.edit.sort-order')"
                                    :placeholder="trans('saas::app.super.settings.themes.edit.sort-order')"
                                >
                                </x-admin::form.control-group.control>
