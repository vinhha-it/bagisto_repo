                        ...
                        <div class="flex items-center justify-between gap-x-2.5">
                            <div class="flex flex-col gap-1">
                                <p class="text-base font-semibold text-gray-800 dark:text-white">
                                    @lang('saas::app.super.settings.themes.edit.slider')
                                </p>
                                
                                <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                                    @lang('saas::app.super.settings.themes.edit.slider-description')
                                </p>
                            </div>
                            ...
                            <div class="flex gap-2.5">
                                ...
                                >
                                    @lang('saas::app.super.settings.themes.edit.slider-add-btn')
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="flex gap-2.5">
                                    <div class="grid place-content-start gap-1.5">
                                        ...
                                        <p class="text-gray-600 dark:text-gray-300">
                                            <div> 
                                                @lang('saas::app.super.settings.themes.edit.link'): 
                                        ...
                                        <p class="text-gray-600 dark:text-gray-300">
                                            <div class="flex justify-between"> 
                                                @lang('saas::app.super.settings.themes.edit.image'): 
                    ...
                    <x-admin::modal ref="addSliderModal">
                        ...
                        <x-slot:header>
                            <p class="text-lg font-bold text-gray-800 dark:text-white">
                                @lang('saas::app.super.settings.themes.edit.update-slider')
                            </p>
                        </x-slot:header>
                        ...
                        <x-slot:content>
                            <x-admin::form.control-group class="px-4py-3 mb-2.5">
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :placeholder="trans('saas::app.super.settings.themes.edit.link')"
                                >
                                </x-admin::form.control-group.control>
                            </x-admin::form.control-group>

                            <x-admin::form.control-group class="px-4py-3">
                                <x-admin::form.control-group.label class="required">
                                    @lang('saas::app.super.settings.themes.edit.slider-image')
                                </x-admin::form.control-group.label>
                            ...
                            <p class="text-xs text-gray-600 dark:text-gray-300">
                                @lang('saas::app.super.settings.themes.edit.image-size')
                            </p>
                        </x-slot:content>
            ...
            methods: {
                saveSliderImage(params, { resetForm ,setErrors }) {
                    ...
                    try {
                        ...
                        if (! sliderImage) {
                            throw new Error("{{ trans('saas::app.super.settings.themes.edit.slider-required') }}");
                        }
