    <div class="fixed top-14 z-[1000] h-full w-[270px] bg-white pt-4 shadow-[0px_8px_10px_0px_rgba(0,_0,_0,_0.2)] transition-all duration-300 group-[.sidebar-collapsed]/container:w-[70px] max-lg:hidden dark:bg-gray-900">
...
@pushOnce('scripts')
    ...
    <script type="module">
        app.component('v-sidebar-collapse', {
            ...
            data() {
                return {
                    isCollapsed: {{ request()->cookie('saas_sidebar_collapsed') ?? 0 }},
                }
            },
            ...
            methods: {
                toggle() {
                    ...
                    document.cookie = 'saas_sidebar_collapsed=' + this.isCollapsed + '; path=/; expires=' + expiryDate.toGMTString();
                ...
                isCollapsedCookie() {
                    ...
                    for (const cookie of cookies) {
                        ...
                        if (name === 'saas_sidebar_collapsed') {
                            return value;
                        }
                    }
