                    ...
                    <x-slot:content class="!p-0">
                        <template v-if="! isShowSavedFilters">
                            ...
                            <x-admin::accordion
                                ...
                                v-if="savedFilters?.available?.length"
                            >
                            ...
                            <x-admin::accordion class="select-none !rounded-none !border-none !shadow-none">
                                <x-slot:header class="px-4">
                                    ...
                                    <div
                                        ...
                                        class="text-xs font-medium leading-6 text-blue-600 transition-all cursor-pointer hover:underline ltr:ml-20 rtl:mr-20"
                                ...
                                >
                                    <form @submit="handleSubmit($event, createOrUpdateFilter)">
                                        <div class="flex flex-col gap-4">
                                            ...
                                            <div class="flex flex-col gap-2 px-4 border-b dark:border-gray-800">
                                                ...
                                                <div class="flex items-center content-end justify-end mb-4">
                                                    <button
                                                        type="submit"
                                                    ...
                                                    <div class="flex items-center content-end justify-end mb-4">
                                                        <div class="grid">
                                                            <div class="flex items-center gap-5 py-2.5">
                                                                <img
                                                                    src="{{ bagisto_asset('images/icon-add-product.svg', 'company') }}"
                                                                    class="w-20 h-20 dark:border-gray-800 dark:mix-blend-exclusion dark:invert"
                                                                >
