                    ...
                    <accordian title="{{ __('admin::app.settings.channels.general') }}" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('hostname') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" id="hostname" v-validate="'required'" name="hostname" value="{{ $channel->hostname }}" placeholder="{{ __('admin::app.settings.channels.hostname-placeholder') }}" data-vv-as="&quot;{{ __('admin::app.settings.channels.hostname') }}&quot;"/>
