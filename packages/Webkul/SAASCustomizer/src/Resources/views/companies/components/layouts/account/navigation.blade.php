...
<div class="panel-side grid grid-cols-[1fr] gap-7.5 max-w-[380px] max-h-[1320px] overflow-y-auto overflow-x-hidden journal-scroll min-w-[342px] max-xl:min-w-[270px] max-md:max-w-full">
    {{-- Account Profile Hero Section --}}
    <div class="grid grid-cols-[auto_1fr] gap-3 items-center px-5 py-6 border border-[#E9E9E9] rounded-xl">
        <div class="">
            <img
                src="{{ $customer->image_url ??  bagisto_asset('images/user-placeholder.png', 'shop') }}"
    ...
    @foreach ($menu->items as $menuItem)
        <div class="max-md:border max-md:border-t-0 max-md:border-r max-md:border-l max-md:border-b max-md:border-[#E9E9E9]   max-md:rounded-md">
            <v-account-navigation>
                ...
                <div class="max-md:flex max-md:gap-x-4 max-md:justify-between max-md:items-center pb-5 max-md:bg-gray-200 max-md:px-6 max-md:py-5 max-md:rounded-tl-[6px] max-md:rounded-tr-[6px] accordian-toggle md:pointer-events-none select-none">
                ...
                <div class="grid border border-t-0 border-r border-l border-b border-[#E9E9E9] rounded-md max-md:hidden max-md:border-none accordian-content">
