@component('shop::emails.layouts.master')
    ...
    <div style="padding: 30px;">
        <div style="font-size: 20px;color: #242424;line-height: 30px;margin-bottom: 34px;">
            ...
            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                {!! __('saas::app.mail.order.greeting-admin', [
                    'order_id'      => '<a href="'.config('app.url').'/super/companies/orders?increment_id[eq]='.$order->increment_id.'" style="color: #0041FF; font-weight: bold;">#'.$order->increment_id.'</a>',
                    'placed_by'     => $order->customer_full_name,
