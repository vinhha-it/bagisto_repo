<x-marketplace::admin.layouts>
    ...
    <v-product-search>
        <div class="relative mt-7 flex items-center">
            ...
            <input 
                type="text" 
                class="peer block h-11 w-full rounded-lg border bg-white px-11 py-3 leading-6 text-gray-600 transition-all hover:border-gray-400 focus:border-gray-400 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 dark:hover:border-gray-400 dark:focus:border-gray-400"
