                    ...
                    <template #item="{ element, index }">
                        <div class="flex cursor-pointer justify-between gap-2.5 border-b border-slate-300 p-4 dark:border-gray-800">
                            ...
                            <div class="flex gap-2.5">
                                <!-- Drag Icon -->
                                <i class="icon-drag pointer-events-none text-xl text-gray-600 transition-all dark:text-gray-300"></i>
                                    ...
                                    <template v-if="selectedLink.type == 'file'">
                                        <x-admin::form.control-group class="flex-1">
                                            ...
                                            <input
                                                type="file"
                                                name="file"
                                                class="flex min-h-10 w-full rounded-md border px-3 py-1 text-sm text-gray-600 transition-all hover:border-gray-400 dark:text-gray-300"
