...
@pushOnce('scripts')
    <script type="text/x-template" id="v-media-videos-template">
        ...
        <div class="grid">
            <div class="flex gap-1">
                <!-- Upload Video Button -->
                <label
                    class="grid h-[120px] max-h-[120px] w-full max-w-[210px] cursor-pointer items-center justify-items-center rounded border border-dashed border-gray-300 transition-all hover:border-gray-400 dark:border-gray-800 dark:mix-blend-exclusion dark:invert"
                    :for="$.uid + '_videoInput'"
                ...
                >
                    <div class="flex flex-col items-center">
                        ...
                        <p class="grid text-center text-sm font-semibold text-gray-800 dark:text-gray-300">
    ...
    <script type="text/x-template" id="v-media-video-item-template">
        <div class="group relative grid h-[120px] max-h-[120px] min-w-[210px] max-w-[210px] justify-items-center overflow-hidden rounded border border-dashed border-gray-300 transition-all hover:border-gray-400 dark:border-gray-800">
            ...
            <div class="invisible absolute bottom-0 top-0 flex w-full flex-col justify-between bg-white p-2.5 opacity-80 transition-all group-hover:visible dark:bg-gray-900">
                <!-- Video Name -->
                ...
                <div class="flex justify-between">
                    <!-- Remove Button -->
                    <span
                        class="mp-delete-icon cursor-pointer rounded-md p-1.5 text-2xl hover:bg-gray-200 dark:hover:bg-gray-800"
                        @click="remove"
                    ></span>
                    ...
                    <!-- Edit Button -->
                    <label
                        class="mp-upload-icon cursor-pointer rounded-md p-1.5 text-2xl hover:bg-gray-200 dark:hover:bg-gray-800"
