    ...
    <script type="text/x-template" id="v-product-search-template">
        ...
        >
            ...
            <x-slot:header>
                <div class="grid gap-[12px]">
                    ...
                    <div class="relative w-full">
                        <input
                            type="text"
                            class="block w-full rounded-lg border bg-white py-[5px] leading-6 text-gray-600 transition-all hover:border-gray-400 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 ltr:pl-[12px] ltr:pr-[40px] rtl:pl-[40px] rtl:pr-[12px]"
            ...
            <x-slot:content class="!p-0">
                ...
                >
                    <div
                        class="flex justify-between gap-[10px] border-b-[1px] border-slate-300 px-[16px] py-[24px] dark:border-gray-800"
                ...
                >
                    ...
                    <img
                        ...
                        class="h-[80px] w-[80px] dark:mix-blend-exclusion dark:invert"
                    />
