...
class PlanExpired extends Mailable
{
    ...
    /**
     * Create a new PlanExpired instance
     *
    ...
    public function build()
    {
        return $this->to($this->company->email)
            ->subject(trans('saas_subscription::app.admin.plans.plan-expired'))
            ->view('saassubscription::emails.admin.plan-expired')->with(['company' => $this->company]);
    }
}
